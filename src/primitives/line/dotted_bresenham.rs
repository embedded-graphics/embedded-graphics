...
impl DottedBresenham {
    ...
    /// Create a new extended bresenham object with the initial error.
...
impl DottedLinePoints {
    ...
    pub(in crate::primitives) fn new(line: &Line, nb_dots_desired: i32) -> Self {
