...
impl MonoFont for Font9x18B {
    const FONT_IMAGE: &'static [u8] = include_bytes!("../../../fonts/latin1/raw/9x18B.raw");
...
impl MonoFont for Font6x13B {
    const FONT_IMAGE: &'static [u8] = include_bytes!("../../../fonts/latin1/raw/6x13B.raw");
    const FONT_IMAGE_WIDTH: u32 = 96;
...
impl MonoFont for Font7x13O {
    const FONT_IMAGE: &'static [u8] = include_bytes!("../../../fonts/latin1/raw/7x13O.raw");
    const FONT_IMAGE_WIDTH: u32 = 112;
