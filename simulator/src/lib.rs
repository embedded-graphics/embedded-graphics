...
//! use embedded_graphics::{egcircle, egline, egtext, primitive_style};
...
//!
//!     egcircle!(center = (96, 32), radius = 31, style = primitive_style!(stroke_color = Some(BinaryColor::On))).draw(&mut display);
//!
//!     egline!(start = (32, 32), end = (1, 32), style = primitive_style!(stroke_color = Some(BinaryColor::On)))
//!         .translate(Point::new(64, 0))
//!         .draw(&mut display);
//!     egline!(start = (32, 32), end = (40, 40), style = primitive_style!(stroke_color = Some(BinaryColor::On)))
//!         .translate(Point::new(64, 0))
//!         .draw(&mut display);
//!
//!     'running: loop {
