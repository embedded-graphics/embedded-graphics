...
//!
//! <div style="display: flex">
//! <img style="width: 128px; height: 128px; display: inline-block; margin-right: 8px;" alt="Draw a line example screenshot" src="data:image/png;base64," />
//! <div style="flex-grow: 1;">
//!
//! ```rust
//! # let mut display = embedded_graphics::mock_display::MockDisplay::default();
